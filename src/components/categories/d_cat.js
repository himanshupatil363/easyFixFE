...
const d_cat =(props,key) =>{
    return(    
        <NavLink key={key} to={`/cat/${props.name}`} className="text-black h-full flex flex-col justify-center items-center text-xl font-bold mx-20 my-10">
